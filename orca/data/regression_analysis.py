...
# 	(df['SHA_slope']).plot(xlim = ('1996-10-01','1997-03-30'), legend = True, ax=axes[0,0])
# 	(df['ORO_slope']).plot(xlim = ('1996-10-01','1997-03-30'), legend = True, ax=axes[0,0])
# 	(df['FOL_slope']).plot(xlim = ('1996-10-01','1997-03-30'), legend = True, ax=axes[0,0])

# 	(df['SHA_intercept']).plot(xlim = ('1997-04-01','1997-07-31'), legend = True, ax=axes[1,1])
# 	(df['ORO_intercept']).plot(xlim = ('1997-04-01','1997-07-31'), legend = True, ax=axes[1,1])
# 	(df['FOL_intercept']).plot(xlim = ('1997-04-01','1997-07-31'), legend = True, ax=axes[1,1])

# 	(df['SHA_mean']).plot(xlim = ('1997-04-01','1997-07-31'), legend = True,ax=axes[2,1])
# 	(df['ORO_mean']).plot(xlim = ('1997-04-01','1997-07-31'), legend = True,ax=axes[2,1])
# 	(df['FOL_mean']).plot(xlim = ('1997-04-01','1997-07-31'), legend = True,ax=axes[2,1])

# 	(df['SHA_std']).plot(xlim = ('1997-04-01','1997-07-31'), legend = True, ax=axes[3,1])
# 	(df['ORO_std']).plot(xlim = ('1997-04-01','1997-07-31'), legend = True, ax=axes[3,1])
# 	(df['FOL_std']).plot(xlim = ('1997-04-01','1997-07-31'), legend = True, ax=axes[3,1])
# 	plt.show()
...
def plot_new_regressions():
	...
	(df['SHA_slope']).plot(xlim = ('1997-10-02','1998-09-30'), ylim = (-0.1,0.1),legend = True, ax=axes[0,0], color = 'r')
