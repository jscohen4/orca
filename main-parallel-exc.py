...
# for index_exceedence_sac in [2,3,4,5,6,7,8]:
...
for inf_exc in [2,3,4,5,6,7,8]:
		SHA_exceedance = {"W": inf_exc, "AN": inf_exc, "BN": inf_exc, "D": inf_exc, "C": inf_exc}
		FOL_exceedance = {"W": 10, "AN": 10, "BN": 5, "D": 2, "C": 1}
		ORO_exceedance = {"W": inf_exc, "AN": inf_exc, "BN": inf_exc, "D": inf_exc, "C": inf_exc}

		SHA_shift = shift
		ORO_shift = shift
		FOL_shift = shift
		model = Model('orca/data/scenario_runs/%s/orca-data-climate-forecasted-%s-excdn_%s.csv'%(s,s,index_exceedence_sac), 
				'orca/data/historical_runs_data/results.csv',SHA_shift, ORO_shift, FOL_shift, SHA_exceedance, FOL_exceedance, ORO_exceedance,sd='10-01-1999',projection = True, sim_gains = True) #climate scenario test
